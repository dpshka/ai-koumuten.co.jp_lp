...
/*■新着情報【日付・本文のみ】■■■■■■■■*/
class MarcatWidgetTriggerItemTopix01_01 extends WP_Widget {
    function __construct() {
        parent::__construct(
            '', // Base ID
            __( 'Newアイコン付き 新着情報【日付・本文のみ】', 'text_domain' ), // Name
            array( 'description' => __( 'Newアイコン付き 新着情報【日付・本文のみ】の新着情報を作成します。' ), ) // Args
        );
    }
                    ...
                    ?>
                     <li>
                        <a href="<?php echo get_the_permalink( $post->ID); ?>">
                            ...
                            <span class="date_topics"><?php echo get_the_date('Y.m.d',$post->ID); ?></span>
                            <span class="title_topics"><?php echo get_the_title($post->ID); ?></span>
                        </a>                
                    </li>
                    <?php
                endforeach;
...
function ListMarcatWidgetTriggerItemTopix01_01() {
    register_widget( 'MarcatWidgetTriggerItemTopix01_01' );
}
add_action( 'widgets_init', 'ListMarcatWidgetTriggerItemTopix01_01' );
?>